                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach var="role" items="${pageInfo.list}" >
                                <tr>
                                    <td><input name="${role.id}" id="ids" type="checkbox" >
                                    </td>
                                    <td>${role.id}</td>
                                    <td>${role.roleName}</td>
                                    <td>${role.roleDesc}</td>
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="window.location.href='${pageContext.request.contextPath}/role/findRoleByIdAndAllPermission.do?roleId=${role.id}'">
                                            添加权限</button>
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="window.location.href='${pageContext.request.contextPath}/role/findById.do?id'">
                                            详情</button>
                                        <button type="button" class="btn bg-olive btn-xs" value="未实现"
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#myDelete").click(function () {
            if(rid!=null){
                var url = "<c:url value="/role/delete"/>"+"/"+rid+".do";
                $.ajax({
                    type : 'post',
                    data : {'_method':'delete'},
                    dataType : 'json',
                    ...
                    success : function(data){
                        window.location.href="http://localhost:8080/role/findAll.do?page=1&size=4";
                    },
                    error:function(){
                        window.location.href="http://localhost:8080/role/findAll.do?page=1&size=4";
                    }
