                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tbody>
                            <c:forEach var="plist" items="${pageInfo.list}" >
                            <tr>
                                <td><input name="${plist.id}" id="ids" type="checkbox" >
                                </td>
                                <td>${plist.id}</td>
                                <td>${plist.productNum}</td>
                                <td>${plist.productName}</td>
                                <td> ${plist.cityName}</td>
                                <td>${plist.departureTimeStr}</td>
                                <td class="text-center">${plist.productPrice}</td>
                                <td class="text-center">${plist.productDesc}</td>
                                <td class="text-center">${plist.productStatusStr}</td>
    ...
    $(document).ready(function() {
       ...
       var pid ;
        ...
        $("#myDelete").click(function () {
            /*document.getElementById("deleteF").action=url;
            ...
            $.ajax({
                ...
                success : function(data){
                    window.location.href="http://localhost:8080/product/findAll.do?page=1&size=4";
                },
                error:function(){
                    window.location.href="http://localhost:8080/product/findAll.do?page=1&size=4";
                }
