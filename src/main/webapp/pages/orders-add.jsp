        ...
        <section class="content"> <!--订单信息-->
            <div class="panel panel-default">
                ...
                <div class="row data-type">
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right"
                                   id="datepicker-a3" name="departureTime" value="<%=time%>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control pull-right"
                               value="这边的值一旦选中就触发selectById将值再次传输并且所有关于productd的值全部填上" name="productPrice">
                        <select class="form-control select2" style="width: 100%"
                                name="productId">
                           <c:forEach items="${ordersList}" var="ordersList">
                            <option value="${ordersList.product.id}">${ordersList.product.id}</option>
                           </c:forEach>
                        </select>
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <input type="text" class="form-control" placeholder="出发城市"
                               value="productId选中这边就有值了" readonly="readonly" >
                    </div>
                    ...
                    <div class="col-md-4 data">
                        <div class="input-group date">
                            ...
                            <input type="text" class="form-control pull-right"
                                   id="datepicker-a6" value="时间" readonly="readonly"
                            >
                        </div>
                    </div>
