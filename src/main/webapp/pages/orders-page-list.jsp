                ...
                <div class="box-body">
                    ...
                    <div class="table-box">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <div class="tab-pane" id="tab-model">
                                        ...
                                        <button type="submit" id="myDelete" class="btn btn-default" title="删除" data-toggle="modal" data-target="#myDelete">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tbody>
                            <c:forEach var="ordersList" items="${pageInfo.list}" >
                                <tr>
                                    <td><input name="${ordersList.id}" id="ids" type="checkbox" >
                                    </td>
                                    <td>${ordersList.id}</td>
                                    <td>${ordersList.orderNum}</td>
                                    <td>${ordersList.product.productName}</td>
                                    <td> ${ordersList.product.productPrice}</td>
                                    <td>${ordersList.orderTimeStr}</td>
                                    <td class="text-center">${ordersList.orderStatusStr}</td>
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="location.href='${pageContext.request.contextPath}/orders/selectById.do?id=${ordersList.id}'">
                                            详情</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#myDelete").click(function () {
            ...
            document.getElementById("deleteF").action="<c:url value="/orders/delete"/>"+"/"+oid+".do";
