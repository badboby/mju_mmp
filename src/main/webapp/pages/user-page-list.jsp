            ...
            <div class="box box-primary">
                    ...
                    <div class="table-box">
                            ...
                            <div class="form-group form-inline">
                                <div class="btn-group">
                                    <div class="tab-pane" id="tab-model">
                                        ...
                                        <button type="button" id="Delete" class="btn btn-default" title="删除" data-toggle="modal" data-target="#myDelete">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc sorting_desc_disabled">用户密码</th>
                            ...
                            <c:forEach var="user" items="${pageInfo.list}" >
                                <tr>
                                    <td><input name="${user.id}" id="ids" type="checkbox" >
                                    </td>
                                    <td>${user.id}</td>
                                    <td>${user.email}</td>
                                    <td>${user.username}</td>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="window.location.href='${pageContext.request.contextPath}/user/findUserByIdAndAllRole.do?userId=${user.id}'">
                                            添加角色</button>
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="window.location.href='${pageContext.request.contextPath}/user/findById.do?userId=${user.id}'">
                                            详情</button>
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="window.location.href='${pageContext.request.contextPath}/pages/update.jsp'">
                                            编辑</button>
                                    </td>
                                </tr>
                            </c:forEach>
                ...
                <div class="box-footer">
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            总共2 页，共14 条数据。 每页
                            <select class="form-control" id="pageOnChange" onchange="pageOnChange()">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                                <option>4</option>
...
<script>
    ...
    $(document).ready(function() {
        ...
        /* var pid = new JSON();
         var p= 0;*/
        var uid ;
        $("#dataList td input[type='checkbox']").on('ifChecked', function(event){
            alert(this.name);
            uid = this.name;
            //p++;
        });
        ...
        $("#myDelete").click(function () {
            if(uid!=null){
                var url = "<c:url value="/user/delete"/>"+"/"+uid+".do";
                $.ajax({
                    type : 'post',
                    data : {'_method':'delete'},
                    dataType : 'json',
                    ...
                    success : function(data){
                        window.location.href="http://localhost:8080/user/findAll.do?page=1&size=4";
                    },
                    error:function(){
                        window.location.href="http://localhost:8080/user/findAll.do?page=1&size=4";
                    }
