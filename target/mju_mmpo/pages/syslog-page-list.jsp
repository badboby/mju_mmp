                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <th class="sorting_desc">访问IP</th>
                                <th class="sorting_desc">资源路径</th>
                                <th class="sorting_desc">执行时间</th>
                            ...
                            <c:forEach var="sysLog" items="${pageInfo.list}" >
                                <tr>
                                    <td><input name="${sysLog.id}" id="ids" type="checkbox" >
                                    </td>
                                    <td>${sysLog.id}</td>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#myDelete").click(function () {
            if(rid!=null){
                var url = "<c:url value="/sysLog/delete"/>"+"/"+rid+".do";
                $.ajax({
                    type : 'post',
                    data : {'_method':'delete'},
                    dataType : 'json',
                    ...
                    success : function(data){
                        window.location.href="http://localhost:8080/sysLog/findAll.do?page=1&size=4";
                    },
                    error:function(){
                        window.location.href="http://localhost:8080/sysLog/findAll.do?page=1&size=4";
                    }
