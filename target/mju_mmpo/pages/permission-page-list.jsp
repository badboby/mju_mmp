                    ...
                    <div class="table-box">
                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <c:forEach var="permission" items="${pageInfo.list}" >
                                <tr>
                                    <td><input name="${permission.id}" id="ids" type="checkbox" >
                                    </td>
                                    <td>${permission.id}</td>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="btn bg-olive btn-xs"
                                                onclick="window.location.href='${pageContext.request.contextPath}/permission/findById.do?pid=${permission.id}'">
                                            详情</button>
...
<script>
    ...
    $(document).ready(function() {
        ...
        $("#myDelete").click(function () {
            if(rid!=null){
                var url = "<c:url value="/permission/delete"/>"+"/"+rid+".do";
                $.ajax({
                    type : 'post',
                    data : {'_method':'delete'},
                    dataType : 'json',
                    ...
                    success : function(data){
                        window.location.href="http://localhost:8080/permission/findAll.do?page=1&size=4";
                    },
                    error:function(){
                        window.location.href="http://localhost:8080/permission/findAll.do?page=1&size=4";
                    }
